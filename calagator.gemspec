...
Gem::Specification.new do |s|
  ...
  s.add_dependency "paper_trail", ">= 16.0", "< 18.0"
  ...
  s.add_dependency "utf8-cleaner", "~> 2.0"
  s.add_dependency "validate_url", "~> 1.0"
  s.add_dependency "will_paginate", "~> 3.0"

  s.add_development_dependency "annotaterb", "~> 4.0"
  ...
  s.add_development_dependency "standard", "~> 1.28.0"
